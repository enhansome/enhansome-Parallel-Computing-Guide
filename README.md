...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,158 | 🐛 382 | 🌐 Go | 📅 2026-08-13 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,476 | 🐛 48 | 🌐 C++ | 📅 2026-08-08 is a very fast, header-only/compiled, C++ logging library.
...
[Java Design Patterns ](https://github.com/iluwatar/java-design-patterns) ⭐ 94,589 | 🐛 157 | 🌐 Java | 📅 2026-07-31 is a collection of the best formalized practices a programmer can use to solve common problems when designing an application or system.
...
[Locust](https://github.com/locustio/locust) ⭐ 28,068 | 🐛 5 | 🌐 Python | 📅 2026-08-10 is an easy to use, scriptable and scalable performance testing tool.
...
[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,289 | 🐛 1,843 | 🌐 Scala | 📅 2026-08-13 is a research compiler that will become Scala 3.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,283 | 🐛 842 | 🌐 JavaScript | 📅 2026-08-09.
