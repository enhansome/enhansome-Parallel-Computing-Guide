...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,454 | 🐛 397 | 🌐 Go | 📅 2026-09-07 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,196 | 🐛 231 | 🌐 Rust | 📅 2026-09-07 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,443 | 🐛 1,188 | 🌐 CMake | 📅 2026-09-04 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Locust](https://github.com/locustio/locust) ⭐ 28,133 | 🐛 4 | 🌐 Python | 📅 2026-09-07 is an easy to use, scriptable and scalable performance testing tool.
...
[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,297 | 🐛 1,863 | 🌐 Scala | 📅 2026-09-07 is a research compiler that will become Scala 3.
