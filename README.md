...
[Play Framework](https://github.com/playframework/playframework) ⭐ 12,617 | 🐛 501 | 🌐 Scala | 📅 2026-09-01 is a web framework combines productivity and performance making it easy to build scalable web applications with Java and Scala.

[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,298 | 🐛 1,863 | 🌐 Scala | 📅 2026-09-04 is a research compiler that will become Scala 3.
