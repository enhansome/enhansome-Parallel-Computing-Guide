...
[Numba](https://github.com/numba/numba) ⭐ 11,155 | 🐛 1,790 | 🌐 Python | 📅 2026-09-17 is an open source, NumPy-aware optimizing compiler for Python sponsored by Anaconda, Inc. It uses the LLVM compiler project to generate machine code from Python syntax. Numba can compile a large subset of numerically-focused Python, including many NumPy functions. Additionally, Numba has support for automatic parallelization of loops, generation of GPU-accelerated code, and creation of ufuncs and C callbacks.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,567 | 🐛 404 | 🌐 Go | 📅 2026-09-18 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,648 | 🐛 339 | 🌐 Python | 📅 2026-09-17 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,301 | 🐛 1,833 | 🌐 Scala | 📅 2026-09-18 is a research compiler that will become Scala 3.
