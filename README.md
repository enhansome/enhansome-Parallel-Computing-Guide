...
[cuML](https://github.com/rapidsai/cuml) ⭐ 5,269 | 🐛 822 | 🌐 Python | 📅 2026-09-02 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
...
[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,297 | 🐛 1,857 | 🌐 Scala | 📅 2026-09-01 is a research compiler that will become Scala 3.
...
[Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) ⭐ 1,204 | 🐛 116 | 🌐 Julia | 📅 2026-08-20 is a univariate and multivariate optimization in Julia.
