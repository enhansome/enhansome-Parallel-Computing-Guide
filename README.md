...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,533 | 🐛 398 | 🌐 Go | 📅 2026-09-15 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,227 | 🐛 223 | 🌐 Rust | 📅 2026-09-15 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,603 | 🐛 50 | 🌐 C++ | 📅 2026-09-05 is a very fast, header-only/compiled, C++ logging library.
...
[Play Framework](https://github.com/playframework/playframework) ⭐ 12,618 | 🐛 487 | 🌐 Scala | 📅 2026-09-15 is a web framework combines productivity and performance making it easy to build scalable web applications with Java and Scala.

[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,301 | 🐛 1,831 | 🌐 Scala | 📅 2026-09-15 is a research compiler that will become Scala 3.
...
[AWS.jl](https://github.com/JuliaCloud/AWS.jl) ⭐ 166 | 🐛 111 | 🌐 Julia | 📅 2026-08-13 is a Julia interface for [Amazon Web Services](https://aws.amazon.com/).
...
[Distributions.jl](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,199 | 🐛 479 | 🌐 Julia | 📅 2026-09-15 is a Julia package for probability distributions and associated functions.
