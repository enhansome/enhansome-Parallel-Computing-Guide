...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,227 | 🐛 396 | 🌐 Go | 📅 2026-08-19 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Java Design Patterns ](https://github.com/iluwatar/java-design-patterns) ⭐ 94,587 | 🐛 137 | 🌐 Java | 📅 2026-08-17 is a collection of the best formalized practices a programmer can use to solve common problems when designing an application or system.
...
[Locust](https://github.com/locustio/locust) ⭐ 28,078 | 🐛 3 | 🌐 Python | 📅 2026-08-10 is an easy to use, scriptable and scalable performance testing tool.
...
[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,291 | 🐛 1,838 | 🌐 Scala | 📅 2026-08-19 is a research compiler that will become Scala 3.
