...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,464 | 🐛 398 | 🌐 Go | 📅 2026-09-08 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,450 | 🐛 1,216 | 🌐 CMake | 📅 2026-09-04 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Play Framework](https://github.com/playframework/playframework) ⭐ 12,618 | 🐛 497 | 🌐 Scala | 📅 2026-09-08 is a web framework combines productivity and performance making it easy to build scalable web applications with Java and Scala.

[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,297 | 🐛 1,858 | 🌐 Scala | 📅 2026-09-08 is a research compiler that will become Scala 3.
