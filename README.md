...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,619 | 🐛 407 | 🌐 Go | 📅 2026-09-22 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
[Play Framework](https://github.com/playframework/playframework) ⭐ 12,617 | 🐛 492 | 🌐 Scala | 📅 2026-09-15 is a web framework combines productivity and performance making it easy to build scalable web applications with Java and Scala.

[Dotty](https://github.com/lampepfl/dotty) ⭐ 6,299 | 🐛 1,848 | 🌐 Scala | 📅 2026-09-22 is a research compiler that will become Scala 3.
